    """
    Permission Auditor T6d3p5c
    ==========================
    Lightweight terminal utility built to audit your filesystem and configurations.
    ...
    APP_NAME    = "Permission Auditor T6d3p5c"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight terminal utility built to audit your filesystem and configurations.")
